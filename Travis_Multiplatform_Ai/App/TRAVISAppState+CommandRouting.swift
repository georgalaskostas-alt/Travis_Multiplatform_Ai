...
extension TRAVISAppState {
    ...
    func sendCommand(_ text: String, source: CommandSource) {
        ...
        // Planning remains an explicit deterministic entry point in Phase A.
        // Natural project creation will be layered on top in the project-agent phase.
        ...
        Task {
            ...
            // Runtime/task control is consumed before ordinary capability
            // routing. Explicit slash commands are local/no-AI; natural control
            // uses the cheap prefilter + semantic classifier.
