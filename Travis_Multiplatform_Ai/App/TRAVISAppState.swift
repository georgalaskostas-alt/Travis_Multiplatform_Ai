...
final class TRAVISAppState {
    ...
    init(){
        ...
        [TextTaskCapability(),market,audit,trading,SelfImprovementCapability(),evolution,fs,advancedFS,productivity,calculation,automation,document,fileSearch,textRead,textTransform,data,batch,artifact,visual,directory,delivery,scaffold,workspace,fcc].forEach{orchestrator.register($0)}
